...
#       Dataset commit used: ba52cfacd7886583f4e285b8326d8ad051dee565 (lastModified 2026-03-27).
...
curl -sfL https://huggingface.co/datasets/open-athena/isoflop-experiments/resolve/main/isoflop_experiments.csv \
  -o isoflop_experiments/isoflop_experiments.csv
curl -sfL https://huggingface.co/datasets/open-athena/isoflop-experiments/resolve/main/README.md \
