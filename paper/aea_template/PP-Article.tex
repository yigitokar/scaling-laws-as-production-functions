% PP-Article.tex for AEA last revised 24 July 2025
\documentclass[PP]{AEA}

% Use the mathptmx package for an accurate page count.
\usepackage{mathptmx}
...
Surname2: affiliation2 (email2). Acknowledgements}}\pubMonth{Month}
\date{\today}
\pubYear{Year}
\pubVolume{Vol}
\pubIssue{Issue}
