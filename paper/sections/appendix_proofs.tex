...
$w\equiv\varepsilon_N/\varepsilon_D$ and the elasticity share is $\varsigma\equiv\varepsilon_N/(\varepsilon_N+\varepsilon_D)$ (not to be confused with the expenditure share $s=(w-1)/w$).
...
\[
\sigma=\frac{\alpha u+\beta v}{\alpha u(1+\beta)+\beta v(1+\alpha)},\qquad\text{equivalently}\qquad \frac1\sigma=1+\varsigma\beta+(1-\varsigma)\alpha.
\]
